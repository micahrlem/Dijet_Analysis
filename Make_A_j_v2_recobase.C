void Make_A_j_v2_recobase(string infile = "jetsMedium0to55.root"){
...
// Make histograms needed
    ...
    TH2F* AjTruthvsReco = new TH2F("AjTruthvsReco", "", 35, -0.3, 0.8, 40, 0, 0.8);
    ...
    for (int i = 0;i<Nentries;i++){
        ...
        if (event != curevent){//first entry of next event
            ...
            if (leading > 15 && subleading > 5 && deltaphi > 1.57 && rleading > 15 && rsubleading > 5 && rdeltaphi > 1.57){
    ...
    outfilename.Prepend("Aj_recobase_");
