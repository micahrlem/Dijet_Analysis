void Make_Aj_Truth_NoCut(string infile = "jets0000small.root"){
...
// Make histograms needed
    ...
    TH1F* hAjTruth = new TH1F("hAjTruth","",50,0,0.8);
    TH1F* hAjReco = new TH1F("hAjReco","",50,0,0.8);
    ...
    for (int i = 0;i<Nentries;i++){ 
        ...
        {
            if (ge > e1)// and ge > 10 and e > 0.80*ge)
            {
                e2 = e1;
                phi2 = phi1;
                e1 = ge;
            ...
            else if (ge > e2)// and ge > 2.5 and e > 0.80*ge)
            {
                e2 = ge;
                re2 = e;
    ...
    outfilename.Prepend("momentum_no_cut_");
