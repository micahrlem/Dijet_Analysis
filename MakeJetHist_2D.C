void MakeJetHist_2D(string infile = "jets0000small.root"){
  ...
  gStyle->SetOptTitle(0);
   ...
   /* TH1F* hRatio = new TH1F("hRatio","",100,0,2);
    ...
    TH2F* RecovsTruth = new TH2F("RecovsTruth","",25,0,1,25,0,2);
    ...
    for (int i = 0;i<Nentries;i++){
        ...
        if (event != curevent){//first entry of next event
           /* hLeadingJetPtNew-> Fill(leading);
            ...
            RecovsTruth->Fill(subleading/leading,rsubleading/rleading);
