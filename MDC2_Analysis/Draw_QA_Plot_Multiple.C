...
TCanvas* can5 = new TCanvas("can5","",1200,1200);
    ...
    ScaleResPt1->SetTitle("P_{T} R = 0.2 P_{T} Hat Min = 20 Gev");
    ...
    SRPTP1->SetTitle("P_{T} R = 0.2 P_{T} Hat Min = 20 Gev");
    SRPTP1->Draw("");
    ...
    TruthvsRecoPt1->SetTitle("P_{T} R = 0.2 P_{T} Hat Min = 20 Gev");
...
/* File 2 */
   TFile *_file2 = TFile::Open(infile2.c_str());
    ...
    ScaleResPt2->SetTitle("P_{T} R = 0.2 P_{T} Hat Min = 30 Gev");
    ...
    SRPTP2->SetTitle("P_{T} R = 0.2 P_{T} Hat Min = 30 Gev");
    SRPTP2->Draw("");
    ...
    TruthvsRecoPt2->SetTitle("P_{T} R = 0.2 P_{T} Hat Min = 30 Gev");
...
/* File 3 */
    ...
    ScaleResPt3->SetTitle("P_{T} R = 0.4 P_{T} Hat Min = 20 Gev");
    ...
    SRPTP3->SetTitle("P_{T} R = 0.4 P_{T} Hat Min = 20 Gev");
    SRPTP3->Draw("");
    ...
    TruthvsRecoPt3->SetTitle("P_{T} R = 0.4 P_{T} Hat Min = 20 Gev");
...
TFile *_file4 = TFile::Open(infile4.c_str());
    ...
    ScaleResPt4->SetTitle("P_{T} R = 0.4 P_{T} Hat Min = 30 Gev");
    ...
    SRPTP4->SetTitle("P_{T} R = 0.4 P_{T} Hat Min = 30 Gev");
    SRPTP4->Draw("");
    ...
    TruthvsRecoPt4->SetTitle("P_{T} R = 0.4 P_{T} Hat Min = 30 Gev");
